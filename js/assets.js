...
WB.ASSETS = (function () {
  ...
  const LIFESTYLE = [
    ...
    { id: "chef",      name: "Private Chef",            icon: "👨‍🍳", cost: 500000, happy: 6, desc: "+6 happiness baseline. Michelin at home, no reservation." },
    ...
    { id: "penthouse", name: "Penthouse Suite",         icon: "🏙️", cost: 5e6,    happy: 5, rep: 20, desc: "+5 happiness, +20 reputation. The whole skyline, from your tub." },
    ...
    { id: "racehorse", name: "Racehorse",               icon: "🐎", cost: 6e7,    happy: 3, rep: 28, desc: "+3 happiness, +28 reputation. He eats better than you do." },
    ...
    { id: "island",    name: "Private Island",          icon: "🏝️", cost: 1.5e9,  happy: 12, rep: 90, desc: "+12 happiness, +90 reputation. No address. No neighbors. No rules." },
  ...
  const USE = {
    ...
    penthouse: { label: "Rooftop party 🏙️",   cd: 600, cost: s => Math.max(8000, WB.GAME.incomePerSec() * 60 * 4), happiness: 28, reputation: 24, followers: 3000, stress: -18, bubble: "The whole city's below us and the bottles are above us." },
    racehorse: { label: "Race day 🐎",         cd: 600, happiness: 18, reputation: 20, stress: -8,  bubble: "He pulled away at the final furlong. Insufferable AND rich now." },
    island:    { label: "Island getaway 🏝️",   cd: 600, happiness: 30, stress: -34, energy: 24,     bubble: "No signal, no meetings — just sand and the faint memory of a mattress." },
